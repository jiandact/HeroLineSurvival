...
public class RoomTrigger2_3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter()
    {
        ...
        else if (GameObject.Find("Camera3").GetComponent<Camera>().enabled == false)
        {
            Debug.Log("if2");
            GameObject.Find("Camera1").GetComponent<Camera>().enabled = false;
            GameObject.Find("Camera2").GetComponent<Camera>().enabled = false;
            GameObject.Find("Camera3").GetComponent<Camera>().enabled = true;
        }
    }
}
